...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  try {
    const org = await updateOrganizationBranding({
      ...
      trainingHeaderLabelColorLight: formColor(form, 'trainingHeaderLabelColorLight'),
      trainingCheckboxColorLight: formColor(form, 'trainingCheckboxColorLight'),
      trainingCheckboxBorderColorLight: formColor(form, 'trainingCheckboxBorderColorLight'),
      ...
      trainingFieldTextColorLight: formColor(form, 'trainingFieldTextColorLight'),
      ...
      trainingListTextColorLight: formColor(form, 'trainingListTextColorLight'),
      trainingCardOutlineColorLight: formColor(form, 'trainingCardOutlineColorLight'),
      trainingCardOutlineTextColorLight: formColor(form, 'trainingCardOutlineTextColorLight'),
      trainingCardOutlineHoverColorLight: formColor(form, 'trainingCardOutlineHoverColorLight'),
      ...
      trainingHeaderLabelColorDark: formColor(form, 'trainingHeaderLabelColorDark'),
      trainingCheckboxColorDark: formColor(form, 'trainingCheckboxColorDark'),
      trainingCheckboxBorderColorDark: formColor(form, 'trainingCheckboxBorderColorDark'),
      ...
      trainingFieldTextColorDark: formColor(form, 'trainingFieldTextColorDark'),
      ...
      trainingListTextColorDark: formColor(form, 'trainingListTextColorDark'),
      trainingCardOutlineColorDark: formColor(form, 'trainingCardOutlineColorDark'),
      trainingCardOutlineTextColorDark: formColor(form, 'trainingCardOutlineTextColorDark'),
      trainingCardOutlineHoverColorDark: formColor(form, 'trainingCardOutlineHoverColorDark'),
      invertLogoDark,
